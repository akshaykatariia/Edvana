...
const CourseDetails = () => {
  const { id } = useParams(); // measn extracting id from url , and this id is of coursedetails
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative item-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        {/* for Right side */}
        <div
          className={`max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] max-h-[750px]`}
        >
          {playerData ? (
            <YouTube
            ...
            <img className="w-full " src={courseData.courseThumbnail} alt="" />
          )}
