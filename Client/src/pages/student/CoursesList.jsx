...
import CorseCard from "../../components/student/CourseCard";
  ...
  return (
    <>
      <div className="relative md:px-36 px-8 pt-20 text-left">
        ...
        <div
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-16
        gap-3 px-2 md:p-0"
        >
          {filteredCourse.map((course, index) => (
            <CorseCard key={index} course={course} />
          ))}
        </div>
      </div>
      <Footer />
