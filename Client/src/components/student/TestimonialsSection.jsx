    ...
    <div className="pb-14 px-8 md:px-0">
      ...
      <div className="grid grid-cols-auto gap-8 mt-14">
        {dummyTestimonial.map((testimonal, index) => (
          <div
            key={index}
            className="text-sm text-left border border-gray-500/30 pb-6 rounding-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden"
          >
            <div className="flex items-center gap-4 px-5 py-4 bg-gray-500/10">
              <img
                className="h-12 w-12 round-full"
